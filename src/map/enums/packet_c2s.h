...
enum class PacketC2S : uint16_t
{
    ...
    // SINGLEPLAYER BEGIN
    GP_CLI_COMMAND_ADDON_RELAY          = 0x151,
    GP_CLI_COMMAND_REQUEST_SERVER_IDENT = 0x153,
    GP_CLI_COMMAND_AUTOMOG_CHANGE_LOOK  = 0x162,
    GP_CLI_COMMAND_AUTOSCROLL           = 0x165,
    GP_CLI_COMMAND_WARP                 = 0x168,
    GP_CLI_COMMAND_AUTOINVITE           = 0x169,
    GP_CLI_COMMAND_INSTANCE_ENTER       = 0x16A,
    GP_CLI_COMMAND_AH_CAT_QUERY         = 0x16F,
    GP_CLI_COMMAND_EQUIP_BOT_ITEM       = 0x171,
    GP_CLI_COMMAND_EQUIP_BY_ID          = 0x173,
    GP_CLI_COMMAND_SPAWN_HEADLESS       = 0x175,
    GP_CLI_COMMAND_HEADLESS_COMMAND     = 0x176,
    GP_CLI_COMMAND_SET_LOT_ASSIGNMENT   = 0x178,
    GP_CLI_COMMAND_USE_FOOD_CONFIG      = 0x17D,
    GP_CLI_COMMAND_LOT_LIST_ACTION      = 0x184,
    GP_CLI_COMMAND_LIST_ALLIANCE_PCS    = 0x185,
    GP_CLI_COMMAND_LIST_BOT_SPELLS      = 0x18B,
    GP_CLI_COMMAND_SET_AUTOSKILL        = 0x191,
    GP_CLI_COMMAND_LIST_AUTOSKILL       = 0x193,
    GP_CLI_COMMAND_AUTOMOG_TRANSFER     = 0x194,
    GP_CLI_COMMAND_AUTOMOG_BOX_PULL     = 0x196,
    GP_CLI_COMMAND_AUTOMOG_SYNTH        = 0x19A,
    GP_CLI_COMMAND_AUTOMOG_CHANGE_JOB   = 0x19C,
    GP_CLI_COMMAND_AUTOMOG_GET_JOB_INFO = 0x19E,
    GP_CLI_COMMAND_BOT_COMMAND          = 0x1A0,
    GP_CLI_COMMAND_AUTOEQUIP_COPY_XML   = 0x1A1,
    GP_CLI_COMMAND_SET_PULLER_NAME_FILTER = 0x1A2,
    GP_CLI_COMMAND_GET_CHAR_PROFILE       = 0x1A7,
    // SINGLEPLAYER END
};
