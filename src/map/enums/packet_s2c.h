...
enum class PacketS2C : uint16_t
{
    ...
    // SINGLEPLAYER BEGIN
    GP_SERV_COMMAND_SERVER_IDENT      = 0x150,
    GP_SERV_COMMAND_ADDON_RELAY       = 0x152,
    GP_SERV_COMMAND_ALLIANCE_EFFECTS  = 0x160,
    GP_SERV_COMMAND_AUTOMOG_CHANGE_LOOK_RESULT = 0x163,
    GP_SERV_COMMAND_AUTOSCROLL_RESULT    = 0x166,
    GP_SERV_COMMAND_ENMITY               = 0x167,
    GP_SERV_COMMAND_AH_CAT_RESULT        = 0x170,
    GP_SERV_COMMAND_EQUIP_BY_ID_RESULT  = 0x174,
    GP_SERV_COMMAND_HEADLESS_STATE      = 0x178,
    GP_SERV_COMMAND_HEADLESS_EVENT      = 0x179,
    GP_SERV_COMMAND_DPS_UPDATE          = 0x17C,
    GP_SERV_COMMAND_ALLIANCE_PC_LIST     = 0x186,
    GP_SERV_COMMAND_BOT_SPELLS_LIST      = 0x18C,
    GP_SERV_COMMAND_PARTY_STATUS         = 0x191,
    GP_SERV_COMMAND_AUTOSKILL_STATE      = 0x192,
    GP_SERV_COMMAND_AUTOMOG_TRANSFER_RESULT = 0x195,
    GP_SERV_COMMAND_AUTOMOG_BOX_RESULT      = 0x197,
    GP_SERV_COMMAND_AUTOMOG_SYNTH_RESULT    = 0x19B,
    GP_SERV_COMMAND_AUTOMOG_CHANGE_JOB_RESULT = 0x19D,
    GP_SERV_COMMAND_AUTOMOG_JOB_INFO          = 0x19F,
    GP_SERV_COMMAND_INSTANCE_ENTER_RESULT     = 0x1A0,
    GP_SERV_COMMAND_AUTOEQUIP_COPY_XML_RESULT = 0x1A2,
    GP_SERV_COMMAND_SYNC_ACK                  = 0x1A3,
    GP_SERV_COMMAND_PULLER_NEARBY_NAMES       = 0x1A4,
    GP_SERV_COMMAND_CHAR_PROFILE              = 0x1A8,
    // SINGLEPLAYER END
};
