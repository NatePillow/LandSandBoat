...
#include "0x160_alliance_effects.h"

#include "entities/charentity.h"
#include "status_effect_container.h"

GP_SERV_COMMAND_ALLIANCE_EFFECTS::GP_SERV_COMMAND_ALLIANCE_EFFECTS(const std::vector<CCharEntity*>& membersList)
{
    auto& packet = this->data();

    for (std::size_t idx = 0; idx < membersList.size() && idx < 12; ++idx)
    {
