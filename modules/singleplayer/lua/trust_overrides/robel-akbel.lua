-----------------------------------
-- SINGLEPLAYER override of scripts/actions/spells/trust/robel-akbel.lua's
-- spellObject.onMobSpawn. Gambits are priority-ordered; this body fully
-- owns Robel Akbel's spawn behavior.
--
-- REBASE AUDIT: diff this against upstream's onMobSpawn body to spot new
-- gambits/mods worth porting:
--   diff <(awk '/spellObject\.onMobSpawn/,/^end$/' scripts/actions/spells/trust/robel-akbel.lua) \
--        <(awk '/registerSpawn.*function/,/^end\)/' modules/singleplayer/lua/trust_overrides/robel-akbel.lua)
-- Last reconciled: 2026-06-16 (upstream baeabac590)
-----------------------------------

local m = Module:new('trust_override_robel_akbel')

xi.singleplayer.trust.registerSpawn('ROBEL_AKBEL', function(mob)
