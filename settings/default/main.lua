...
xi.settings.main =
{
    ...
    COFFER_MAX_ILLUSION_TIME = 10,--3600,  -- 1 hour
    COFFER_MIN_ILLUSION_TIME = 5,--1800,  -- 30 minutes
    CHEST_MAX_ILLUSION_TIME  = 10,--3600,  -- 1 hour
    CHEST_MIN_ILLUSION_TIME  = 5,--1800,  -- 30 minutes
